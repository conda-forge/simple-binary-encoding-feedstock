About simple-binary-encoding-feedstock
======================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/simple-binary-encoding-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/simple-binary-encoding-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add sbe-cxx sbe-java
# for installing globally
pixi global install sbe-cxx sbe-java
```
...
It is possible to list all of the versions of `sbe-cxx` available on your platform:
...
```
pixi search sbe-cxx --channel conda-forge
```
